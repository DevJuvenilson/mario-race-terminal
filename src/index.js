    ...
    for (let round = 1; round <= 5; round++) {
        ...
        if (block === "CONFRONTO") {
            ...
            if (powerResult1 > powerResult2 && character2.PONTOS == 0) {
                console.log(`${character1.NOME} venceu o confronto! ${character2.NOME} perdeu nenhum ponto!🐢`);
            }
            ...
            if (powerResult2 > powerResult1 && character1.PONTOS == 0) {
                console.log(`${character2.NOME} venceu o confronto! ${character1.NOME} perdeu nenhum ponto!🐢`);
            }
            ...
            */
            ...
            /* OS DOIS IF TERNARIOS SUBSTITUI TUDO ISSO
...
// PARÊNTESE DIZENDO QUE ESSA É UMA FUNÇÃO AUTO INVOCÁVEL
(async function main() {
    console.log(
